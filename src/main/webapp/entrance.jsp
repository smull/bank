...
<%
    ...
    if (surname!=null && datepicker!=null && !surname.isEmpty() && !datepicker.isEmpty()){
        //surname = (String) request.getSession().getAttribute("surname");
        //datepicker = (String) request.getSession().getAttribute("datepicker");
        System.out.println(surname + " " + datepicker);
        System.out.println(creditCard + " " + cvv + " " + secretAnswer + " " + secretQuestion);
        System.out.println(countries + " " + city + " " + street + " " + building);
    }
%>


<!-- multistep form -->
<form id="msform" action="entrance.jsp" method="get">
    <!-- progressbar -->
    <ul id="progressbar">
        <li class="active">Account Setup</li>
        <li>Credit card Profiles</li>
    ...
    <fieldset id="msformF">
        ...
        <input type="text"  name="datepicker" id="datepicker" placeholder="Your birthday" size="30"/>
        <!--<input type="text" data-beatpicker="true" data-beatpicker-position="['right','bottom']"/>-->
        <!--<input type="password" name="pass" placeholder="Password" />
        <input type="password" name="cpass" placeholder="Confirm Password" />-->
        <input type="button" name="next" class="next action-button" value="Next" />
        <div id="checkboxHid" name = "checkboxHid" style="display: none">
        <input id="lg" type="checkbox"/>
        <label class="ui-widget">I accept your rules!</label>
        </div>
    </fieldset>
    <fieldset>
        <h2 class="fs-title">Credit card Profiles</h2>
        ...
        <input type="text" id="secretQuestion" name="secretQuestion" placeholder="Secret question" />
        <input type="text" id="secretAnswer" name="secretAnswer" placeholder="Secret answer" />
    ...
    <fieldset>
        ...
        <select name="countries" id="countries"  style="width:250px; margin-bottom: 50px" title="Please select something!" >
